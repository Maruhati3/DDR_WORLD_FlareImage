window.MakeFlareImage = function () {
  ...
  style.innerHTML =
    "#ddr_right #data_tbl td:nth-child(1) { width: 15% !important; }";
  ...
  document.querySelectorAll(".data").forEach((aSong) => {
    ...
    if (Difficulties[0] == "EXPERT") {
      JK.style = "width:calc(100% - 4px);border: solid 4px #369722";
    } else if (Difficulties[0] == "CHALLENGE") {
      JK.style = "width:calc(100% - 4px);border: solid 4px #bc26c1";
    } else if (Difficulties[0] == "DIFFICULT") {
      JK.style = "width:calc(100% - 4px);border: solid 4px #c2050b";
    } else if (Difficulties[0] == "BASIC") {
      JK.style = "width:calc(100% - 4px);border: solid 4px #ffde00";
    } else if (Difficulties[0] == "BEGINNER") {
      JK.style = "width:calc(100% - 4px);border: solid 4px #0fa7ff";
    }
    aSong.children[4].remove();
    aSong.firstElementChild.rowSpan = 2;
    aSong.firstElementChild.firstChild.parentNode.insertAdjacentHTML(
      "afterend",
      '<td colspan="3" width="calc(85%)">' +
        aSong.firstElementChild.children[1].outerHTML +
        "</td>"
    );
    aSong.firstElementChild.children[1].remove();
    aSong.children[1].style =
      "max-width:calc(85%);text-align:left;overflow:hidden;white-space: nowrap;text-overflow: ellipsis;";
  ...
  document.querySelectorAll(".graph_title").forEach((tbl) => {
    ...
    tbl.style =
      "width:calc(31.5%);padding:0;padding-top:4px;padding-bottom:4px;";
  });
  //余計な要素の処理
  ...
  var mainsize = window.getComputedStyle(document.querySelector(".main")).width;
  console.log(mainsize);

  document.querySelectorAll("#data_tbl").forEach((tbl) => {
    tbl.style =
      "width:calc(100%/3);font-size:calc(220% *"+mainsize+ "/1400px );table-layout:fixed;";
  });
  //画像化-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //画像化-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //画像化-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
